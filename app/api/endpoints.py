...
#             # 短文本：直接走单次 LLM
#             reply = llm(user_message).strip()
#         else:
#             # 长文本：切块 + 分批提问
#             chunks = split_text_into_chunks(user_message, max_chunk_size=1500)
#             reply = await ask_llm_in_batches(llm, chunks, system_prompt="Please summarize the following text carefully.")

#         return {
#             "id": "chat_" + str(hash(user_message)),
#             "content": reply
#         }
